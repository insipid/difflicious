...
class TestGitRepository:
    ...
    def test_sanitize_args_valid(self, temp_git_repo):
    ...
    def test_sanitize_args_dangerous_characters(self, temp_git_repo):
    ...
    def test_sanitize_args_invalid_type(self, temp_git_repo):
    ...
    def test_is_safe_git_option(self, temp_git_repo):
    ...
    def test_is_safe_file_path(self, temp_git_repo):
    ...
    def test_execute_git_command_success(self, mock_run, temp_git_repo):
    ...
    @patch("subprocess.run")
    def test_execute_git_command_timeout(self, mock_run, temp_git_repo):
    ...
    @patch("subprocess.run")
    def test_execute_git_command_file_not_found(self, mock_run, temp_git_repo):
    ...
    def test_get_status_with_changes(self, mock_execute, temp_git_repo):
    ...
    def test_parse_diff_output(self, temp_git_repo):
    ...
    def test_parse_diff_output_empty(self, temp_git_repo):
...
class TestGitRepositoryCommitComparison:
    ...
    @patch("difflicious.git_operations.GitRepository._execute_git_command")
    def test_is_safe_commit_sha_valid_references(self, mock_execute, temp_git_repo):
    ...
    def test_is_safe_commit_sha_invalid_references(self, temp_git_repo):
    ...
    def test_is_safe_commit_sha_invalid_types_and_lengths(self, temp_git_repo):
    ...
    def test_get_diff_with_default_branch_comparison(
        self, mock_get_branches, mock_execute, temp_git_repo
    ):
    ...
    @patch("difflicious.git_operations.GitRepository._execute_git_command")
    def test_get_diff_with_head_comparison(self, mock_execute, temp_git_repo):
    ...
    def test_get_diff_with_file_path_filter(self, temp_git_repo):
        """Test get_diff with specific file path filter."""
        repo = GitRepository(str(temp_git_repo))

        # Create a test file for filtering
        test_file = temp_git_repo / "specific_file.txt"
    ...
    @patch("difflicious.git_operations.GitRepository._execute_git_command")
    def test_get_file_diff_with_commits(self, mock_execute, temp_git_repo):
    ...
    @patch("difflicious.git_operations.GitRepository._execute_git_command")
    def test_get_file_diff_with_base_commit_only(self, mock_execute, temp_git_repo):
...
class TestGitRepositoryBranches:
    ...
    @patch("difflicious.git_operations.GitRepository._execute_git_command")
    def test_get_branches_success(self, mock_execute, temp_git_repo):
    ...
    @patch("difflicious.git_operations.GitRepository._execute_git_command")
    def test_get_branches_default_detection(self, mock_execute, temp_git_repo):
    ...
    @patch("difflicious.git_operations.GitRepository._execute_git_command")
    def test_get_branches_empty_repo(self, mock_execute, temp_git_repo):
    ...
    @patch("difflicious.git_operations.GitRepository._execute_git_command")
    def test_get_branches_remote_branches(self, mock_execute, temp_git_repo):
...
class TestGitRepositoryFileOperations:
    ...
    def test_get_file_lines_range_validation(self, temp_git_repo):
    ...
    def test_get_file_lines_file_not_found(self, temp_git_repo):
...
class TestGitRepositoryDiffOperations:
    ...
    @patch("difflicious.git_operations.GitRepository._execute_git_command")
    def test_get_full_file_diff_success(self, mock_execute, temp_git_repo):
    ...
    @patch("difflicious.git_operations.GitRepository._execute_git_command")
    def test_get_full_file_diff_with_base_ref(self, mock_execute, temp_git_repo):
    ...
    @patch("difflicious.git_operations.GitRepository._execute_git_command")
    def test_get_full_file_diff_use_cached(self, mock_execute, temp_git_repo):
    ...
    @patch("difflicious.git_operations.GitRepository._execute_git_command")
    def test_get_full_file_diff_file_not_found(self, mock_execute, temp_git_repo):
...
class TestGitRepositoryMetadata:
    ...
    @patch("difflicious.git_operations.GitRepository._execute_git_command")
    def test_get_current_branch_success(self, mock_execute, temp_git_repo):
    ...
    @patch("difflicious.git_operations.GitRepository._execute_git_command")
    def test_get_current_branch_detached_head(self, mock_execute, temp_git_repo):
    ...
    @patch("difflicious.git_operations.GitRepository._execute_git_command")
    def test_get_repository_name_from_remote(self, mock_execute, temp_git_repo):
    ...
    def test_get_repository_name_fallback(self, temp_git_repo):
...
class TestGitRepositoryFileStatus:
    ...
    @patch("difflicious.git_operations.GitRepository._execute_git_command")
    def test_get_file_status_map_unstaged(self, mock_execute, temp_git_repo):
    ...
    @patch("difflicious.git_operations.GitRepository._execute_git_command")
    def test_get_file_status_map_staged(self, mock_execute, temp_git_repo):
    ...
    @patch("difflicious.git_operations.GitRepository._execute_git_command")
    def test_get_file_status_map_branch_comparison(self, mock_execute, temp_git_repo):
    ...
    @patch("difflicious.git_operations.GitRepository._execute_git_command")
    def test_get_file_status_map_renames(self, mock_execute, temp_git_repo):
...
class TestGitRepositorySafePaths:
    ...
    def test_is_safe_file_path_valid(self, temp_git_repo):
        """Test safe file path validation with valid paths."""
        repo = GitRepository(str(temp_git_repo))

        # Create a test file
        test_file = temp_git_repo / "valid_path.py"
    ...
    def test_is_safe_file_path_traversal(self, temp_git_repo):
