...
- [x] **C1. Version still at 0.10.0** ✅ FIXED
  Bumped to `"1.0.0"` in `src/difflicious/__init__.py`.
...
### Batch 1: Release Metadata & Config ✅ COMPLETED

- [x] Bump `__version__` to `1.0.0` — `__init__.py` (C1) ✅
