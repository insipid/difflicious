...
- [ ] **M2. Dead parameters in `diff_service.py:27-43`**
  `unstaged` and `untracked` params documented as "kept for backward compatibility" but always overridden to `True` at lines 63-64. Misleading API surface.
